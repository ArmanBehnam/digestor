...
import json
import time
from ocr_tools.core.models import ExtractionResult, ProcessingMethod, DocumentType, ExtractedElement, SpatialTable, ImageInfo, ProcessingMetrics
from ocr_tools.core.exceptions import PDFProcessorError, FileNotFoundError, UnsupportedFileTypeError, ProcessingError, ValidationError
from ocr_tools.core.interfaces import ProcessingPipeline
from ocr_tools.stages.base import PDFTextStage, OCRStage, TableStage, PatternStage, SpatialStage, ClassificationStage, FinalizationStage
from ocr_tools.exporters.json_exporter import create_json_exporter

from ocr_tools.config.settings import get_config, initialize_config
from ocr_tools.ocr_engine.base import get_ocr_registry
from ocr_tools.processors.image import create_image_processor
from ocr_tools.processors.pattern import create_pattern_processor
from ocr_tools.extractors.pdf_extractor import create_pdf_extractor
from ocr_tools.processors.spatial_analyzer import create_spatial_analyzer
from ocr_tools.processors.document_classifier import create_document_classifier
from ocr_tools.utils.logging_utils import setup_logging
from ocr_tools.exporters.json_exporter import JSONExporter
...
class PDFProcessor(ProcessingPipeline):
    ...
    def _register_ocr_engines(self) -> None:
        ...
        ocr_engines = [
            ('ocr_tools.ocr_engine.aws_textract', 'create_aws_textract_engine'),
            ('ocr_tools.ocr_engine.azure', 'create_azure_ocr_engine'),
            ('ocr_tools.ocr_engine.claude', 'create_claude_ocr_engine'),
            # ('ocr_tools.ocr_engine.mistral', 'create_mistral_ocr_engine'),
            ('ocr_tools.ocr_engine.tesseract', 'create_tesseract_engine'),
            ('ocr_tools.ocr_engine.opencv', 'create_opencv_engine')
        ]
