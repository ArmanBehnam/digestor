...
class EngineeringQAAgent(Talk2DrawingsBaseAgent):
    """Agent for engineering question answering with hierarchical LLMs"""
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        try:
            ...
            # Load your existing LLM configuration
            ...
            print(f"⚠️ {self.name}: Could not load LLM interface: {e}")
            self.llm_interface = None
            self.questions = []
            self.is_available = False

    def validate_input(self, input_data: Any) -> bool:
        """Validate input has filtered pages"""
    ...
    async def process(self, ocr_data: Dict[str, Any], context: Dict[str, Any] = None) -> Dict[str, Any]:
        """Process questions using hierarchical LLM engines"""
        ...
        try:
            ...
            # Get filtered pages from OCR agent
            filtered_pages = ocr_data['filtered_pages']['matching_pages']

            if not filtered_pages:
                print("⚠️ No filtered pages found, cannot proceed")
                return {
                    'success': False,
                    'agent': self.name,
            ...
            # Combine page text for processing
            combined_text = ""
            ...
            # Use your existing LLM interface to process questions
